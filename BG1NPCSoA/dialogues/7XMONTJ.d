...
SAY @825
IF ~OR(3) !InParty("ELDOTH")StateCheck("ELDOTH",CD_STATE_NOTVALID) !InMyArea("ELDOTH")~ THEN REPLY @826 GOTO RomanceTalk1-1-1
IF ~OR(3) !InParty("ELDOTH")StateCheck("ELDOTH",CD_STATE_NOTVALID) !InMyArea("ELDOTH")~ THEN REPLY @827 GOTO RomanceTalk1-1-2
IF ~OR(3) !InParty("ELDOTH")StateCheck("ELDOTH",CD_STATE_NOTVALID) !InMyArea("ELDOTH")~ THEN REPLY @3 DO ~SetGlobal("MontyRomanceActive","GLOBAL",3)~ GOTO RomanceBuzzKill3
IF ~OR(3) !InParty("ELDOTH")StateCheck("ELDOTH",CD_STATE_NOTVALID) !InMyArea("ELDOTH")~ THEN REPLY @4 DO ~SetGlobal("MontyRomanceActive","GLOBAL",3)~ GOTO RomanceBuzzKill2
IF ~InParty("ELDOTH")!StateCheck("ELDOTH",CD_STATE_NOTVALID) InMyArea("ELDOTH")~ THEN EXTERN IF_FILE_EXISTS 7XEldoJ RomanceTalk1-1-Eldoth
END
...
!StateCheck("MONTARON",CD_STATE_NOTVALID) !StateCheck(Player1,CD_STATE_NOTVALID)
CombatCounter(0) 
...
== 7XMONTJ IF ~InParty("MONTARON")!StateCheck("MONTARON",CD_STATE_NOTVALID)~ THEN
@208
=
@209
==EDWIN
...
EXTEND_BOTTOM ARAN 49
	IF ~InParty("MONTARON")!StateCheck("MONTARON",CD_STATE_NOTVALID)~ THEN EXTERN 7XMONTJ MontiAran1
END

EXTEND_BOTTOM ARAN 51
	IF ~InParty("MONTARON")!StateCheck("MONTARON",CD_STATE_NOTVALID)~ THEN EXTERN 7XMONTJ MontiAran2
END

EXTEND_BOTTOM ARAN 4
     IF ~InParty("MONTARON")!StateCheck("MONTARON",CD_STATE_NOTVALID)
...
I_C_T PLAYER1 25 7xMonty_Hell
  == 7XMONTJ IF ~InParty("MONTARON") !StateCheck("MONTARON",CD_STATE_NOTVALID)~ THEN @772
END

I_C_T GARREN 18 7xMonty_GARREN-18
  == 7XMONTJ IF ~InParty("MONTARON") !StateCheck("MONTARON",CD_STATE_NOTVALID)~ THEN @773
  == GARREN @774
END

INTERJECT_COPY_TRANS C6BODHI 0 7xMonty_C6BODHI-0
  == 7XMONTJ IF ~InParty("MONTARON") !StateCheck("MONTARON",CD_STATE_NOTVALID)~ THEN @795
END
