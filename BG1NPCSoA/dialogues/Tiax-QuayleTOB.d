...
IF ~InParty("TIAX")~ THEN REPLY @0 GOTO TiaxVolo
END
...
=
@2
== 7XTIA25J IF ~InParty("TIAX") !StateCheck("TIAX",CD_STATE_NOTVALID)~ THEN @3
EXTERN SARVOLO 9



EXTEND_BOTTOM SARVOLO 9
IF ~InParty("QUAYLE")~ THEN REPLY @4 GOTO QuayleVolo
END
...
=
@8
== 7XQUA25J IF ~InParty("QUAYLE") !StateCheck("QUAYLE",CD_STATE_NOTVALID)~ THEN @9
=
@10
EXTERN SARVOLO 9
...
THEN
  REPLY @12
    DO ~CreateVisualEffect("SPPORTAL",[1999.1218])
	 ...
	 SmallWait(10) 
	 ActionOverride("TIAX",StartDialogNoSet([PC]))~
EXIT
END
...
== 7XTIA25J IF ~InParty("TIAX")!StateCheck("TIAX",CD_STATE_NOTVALID)~ THEN
@25
== CHALCY01 @26
== 7XTIA25J @27
== CHALCY01 @28
...
IF ~InParty("TIAX")!StateCheck("TIAX",CD_STATE_NOTVALID)~ THEN DO ~SetGlobal("TiaxAR4500Talk","AR4500",1)~ EXIT
END
...
See("Sarevok")
!StateCheck("Sarevok",STATE_SLEEPING)InParty("TIAX") InMyArea("TIAX") !StateCheck("TIAX",CD_STATE_NOTVALID)
...
Global("babytalk","GLOBAL",0)InParty("TIAX") InMyArea("TIAX") !StateCheck("TIAX",CD_STATE_NOTVALID)
...
Global("TiaxAnomenTob1","GLOBAL",0)InParty("TIAX") InMyArea("TIAX") !StateCheck("TIAX",CD_STATE_NOTVALID)
...
IF ~InParty("Aerie")
See("Aerie")
!StateCheck("Aerie",STATE_SLEEPING)InParty("TIAX") InMyArea("TIAX") !StateCheck("TIAX",CD_STATE_NOTVALID)
...
See("Haerdalis")
!StateCheck("Haerdalis",STATE_SLEEPING)InParty("TIAX") InMyArea("TIAX") !StateCheck("TIAX",CD_STATE_NOTVALID)
...
InParty("TIAX") InMyArea("TIAX") !StateCheck("TIAX",CD_STATE_NOTVALID)
...
CHAIN IF ~InParty("TIAX") InMyArea("TIAX") !StateCheck("TIAX",CD_STATE_NOTVALID)InMyArea("QUAYLE")InParty("QUAYLE") 
!StateCheck("QUAYLE",CD_STATE_NOTVALID)Global("QuayleTiaxToB","GLOBAL",0) CombatCounter(0)~ THEN ~B7XQUA25~ QuayleTiaxToB1
...
CHAIN IF ~InParty("TIAX") InMyArea("TIAX") !StateCheck("TIAX",CD_STATE_NOTVALID)InMyArea("QUAYLE")InParty("QUAYLE") 
!StateCheck("QUAYLE",CD_STATE_NOTVALID)Global("QuayleTiaxToB","GLOBAL",1) CombatCounter(0)~ THEN ~B7XQUA25~ QuayleTiaxToB2
@140
=
...
CHAIN IF ~InParty("TIAX") InMyArea("TIAX") !StateCheck("TIAX",CD_STATE_NOTVALID)InMyArea("QUAYLE")InParty("QUAYLE") 
!StateCheck("QUAYLE",CD_STATE_NOTVALID)Global("QuayleTiaxToB","GLOBAL",2) CombatCounter(0)~ THEN ~B7XTIA25~ QuayleTiaxToB3
@150
=
...
IF ~InParty("Aerie")
See("Aerie")
!StateCheck("Aerie",STATE_SLEEPING)InMyArea("QUAYLE")InParty("QUAYLE") 
...
InParty("Jan")
Range("Jan",30)
!StateCheck("Jan",CD_STATE_NOTVALID)InMyArea("QUAYLE")InParty("QUAYLE") 
!StateCheck("QUAYLE",CD_STATE_NOTVALID)
...
== 7XQUA25J IF ~InParty("QUAYLE") InMyArea("QUAYLE") !StateCheck("QUAYLE",CD_STATE_NOTVALID)~ THEN
@191
=
@192
END
...
== 7XTIA25J  IF ~InParty("TIAX") InMyArea("TIAX") !StateCheck("TIAX",CD_STATE_NOTVALID)~ THEN @244
== 7XQUA25J IF ~InParty("QUAYLE") InMyArea("QUAYLE") !StateCheck("QUAYLE",CD_STATE_NOTVALID)~ THEN @246
END

INTERJECT_COPY_TRANS3 BAZDRA01 0 7XQUA25JBAZDRA01-0
== 7XTIA25J  IF ~InParty("TIAX") InMyArea("TIAX") !StateCheck("TIAX",CD_STATE_NOTVALID)~ THEN @248
== 7XQUA25J IF ~InParty("QUAYLE") InMyArea("QUAYLE") !StateCheck("QUAYLE",CD_STATE_NOTVALID)~ THEN @245
END

INTERJECT_COPY_TRANS YAGA01 2 7XQUA25JYAGA01-2
== 7XQUA25J IF ~InParty("QUAYLE") InMyArea("QUAYLE") !StateCheck("QUAYLE",CD_STATE_NOTVALID)~ THEN @253
== YAGA01 IF ~InParty("QUAYLE") InMyArea("QUAYLE") !StateCheck("QUAYLE",CD_STATE_NOTVALID)~ THEN @254
== 7XQUA25J IF ~InParty("QUAYLE") InMyArea("QUAYLE") !StateCheck("QUAYLE",CD_STATE_NOTVALID)~ THEN @255
== YAGA01 IF ~InParty("QUAYLE") InMyArea("QUAYLE") !StateCheck("QUAYLE",CD_STATE_NOTVALID)~ THEN @256
END


INTERJECT_COPY_TRANS SARGRD01 0 7XTIA25JMilitiaGuard
  == 7XTIA25J  IF ~InParty("TIAX") InMyArea("TIAX") !StateCheck("TIAX",CD_STATE_NOTVALID)~ THEN @193
END
...
INTERJECT_COPY_TRANS SARBAR01 11 7XTIA25JSARBAR01-11
  == 7XTIA25J  IF ~InParty("TIAX") InMyArea("TIAX") !StateCheck("TIAX",CD_STATE_NOTVALID)~ THEN @194
=
@195
END

INTERJECT_COPY_TRANS SARBAR02 0 7XTIA25JSARBAR02-0
  == 7XTIA25J  IF ~InParty("TIAX") InMyArea("TIAX") !StateCheck("TIAX",CD_STATE_NOTVALID)~ THEN @196
END
...
INTERJECT_COPY_TRANS SARBHA02 0 7XTIA25JSARBHA02-0
  == 7XTIA25J  IF ~InParty("TIAX") InMyArea("TIAX") !StateCheck("TIAX",CD_STATE_NOTVALID)~ THEN @197
END
...
INTERJECT_COPY_TRANS SARBOY01 1 7XTIA25JSARBOY01-1
  == 7XTIA25J  IF ~InParty("TIAX") InMyArea("TIAX") !StateCheck("TIAX",CD_STATE_NOTVALID)~ THEN @198
=
@199
END
...
INTERJECT_COPY_TRANS SARBUL01 0 7XTIA25JSARBUL01-0
  == 7XTIA25J  IF ~InParty("TIAX") InMyArea("TIAX") !StateCheck("TIAX",CD_STATE_NOTVALID)~ THEN @202
END

INTERJECT_COPY_TRANS SARBUL06 3 7XTIA25JSARBUL06-3
  == 7XTIA25J  IF ~InParty("TIAX") InMyArea("TIAX") !StateCheck("TIAX",CD_STATE_NOTVALID)~ THEN @203
=
@204
END
...
INTERJECT_COPY_TRANS SARBUL05 0 7XTIA25JSARBUL05-0
  == 7XTIA25J  IF ~InParty("TIAX") InMyArea("TIAX") !StateCheck("TIAX",CD_STATE_NOTVALID)~ THEN @205
END


INTERJECT_COPY_TRANS SARCNT01 18 7XTIA25JSARCNT01-18
  == 7XTIA25J  IF ~InParty("TIAX") InMyArea("TIAX") !StateCheck("TIAX",CD_STATE_NOTVALID)~ THEN @206
END


INTERJECT_COPY_TRANS SARDW01 0 7XTIA25JSARDW01-0
  == 7XTIA25J  IF ~InParty("TIAX") InMyArea("TIAX") !StateCheck("TIAX",CD_STATE_NOTVALID)~ THEN @207
=
@208
=
@209
...
INTERJECT_COPY_TRANS AMMAYOR 3 7XTIA25JAMMAYOR-3
  == 7XTIA25J  IF ~InParty("TIAX") InMyArea("TIAX") !StateCheck("TIAX",CD_STATE_NOTVALID)~ THEN @230
  =@231
  =@232  
END

INTERJECT_COPY_TRANS MARLOWE 9 7XTIA25JMARLOWE-9
  == 7XTIA25J  IF ~InParty("TIAX") InMyArea("TIAX") !StateCheck("TIAX",CD_STATE_NOTVALID)~ THEN @233
  == MARLOWE IF ~InParty("TIAX") InMyArea("TIAX") !StateCheck("TIAX",CD_STATE_NOTVALID)~ THEN @234
END
...
INTERJECT_COPY_TRANS AMCST04 4 7XTIA25JAMCST04-4
  == 7XTIA25J  IF ~InParty("TIAX") InMyArea("TIAX") !StateCheck("TIAX",CD_STATE_NOTVALID)~ THEN @235
END

INTERJECT_COPY_TRANS FINMEL01 0 7XTIA25JFINMEL01-0
  == 7XTIA25J  IF ~InParty("TIAX") InMyArea("TIAX") !StateCheck("TIAX",CD_STATE_NOTVALID)~ THEN @238
  == FINMEL01 IF ~InParty("TIAX") InMyArea("TIAX") !StateCheck("TIAX",CD_STATE_NOTVALID)~ THEN @239
END

INTERJECT_COPY_TRANS FINMEL01 10 7XTIA25JFINMEL01-10
  == 7XTIA25J  IF ~InParty("TIAX") InMyArea("TIAX") !StateCheck("TIAX",CD_STATE_NOTVALID)~ THEN @240
  == FINMEL01 IF ~InParty("TIAX") InMyArea("TIAX") !StateCheck("TIAX",CD_STATE_NOTVALID)~ THEN @241
END

INTERJECT_COPY_TRANS FINSOL01 18 7XTIA25JFINSOL01-18
  == 7XTIA25J  IF ~InParty("TIAX") InMyArea("TIAX") !StateCheck("TIAX",CD_STATE_NOTVALID)~ THEN @242
END
...
INTERJECT_COPY_TRANS3 FINSOL01 27 TiaxQuayleFINSOL01-27
  == 7XQUA25J IF ~InParty("QUAYLE") InMyArea("QUAYLE") !StateCheck("QUAYLE",CD_STATE_NOTVALID)~ THEN @258
  == 7XTIA25J  IF ~InParty("TIAX") InMyArea("TIAX") !StateCheck("TIAX",CD_STATE_NOTVALID)~ THEN @243
END

INTERJECT_COPY_TRANS CHALRV01 1 7XTIA25JCHALRV01-1
  == 7XTIA25J  IF ~InParty("TIAX") InMyArea("TIAX") !StateCheck("TIAX",CD_STATE_NOTVALID)~ THEN @249
END

INTERJECT_COPY_TRANS ABAZIGAL 0 7XTIA25JABAZIGAL-0
  == 7XTIA25J  IF ~InParty("TIAX") InMyArea("TIAX") !StateCheck("TIAX",CD_STATE_NOTVALID)~ THEN @250
  == ABAZIGAL  IF ~InParty("TIAX") InMyArea("TIAX") !StateCheck("TIAX",CD_STATE_NOTVALID)~ THEN @251
  == 7XTIA25J  IF ~InParty("TIAX") InMyArea("TIAX") !StateCheck("TIAX",CD_STATE_NOTVALID)~ THEN @225
  == ABAZIGAL  IF ~InParty("TIAX") InMyArea("TIAX") !StateCheck("TIAX",CD_STATE_NOTVALID)~ THEN @252 
END
...
INTERJECT_COPY_TRANS FINSOL01 0 7XTIA25JFINSOL01-0
  == 7XTIA25J  IF ~InParty("TIAX") InMyArea("TIAX") !StateCheck("TIAX",CD_STATE_NOTVALID)~ THEN @257
END

INTERJECT_COPY_TRANS GORODR1 4 Tiax25GORODR1-4
== 7XTIA25J IF ~GlobalGT("Chapter","GLOBAL",%bg2_chapter_7%) InParty("TIAX") InMyArea("TIAX") !StateCheck("TIAX",CD_STATE_NOTVALID)~ THEN @263
== GORODR1 @264
END

INTERJECT_COPY_TRANS SARMEL01 17 7XTIA25JSARMEL01-17
  == 7XTIA25J  IF ~InParty("TIAX") InMyArea("TIAX") !StateCheck("TIAX",CD_STATE_NOTVALID)~ THEN @259
  == SARMEL01 @260
  == 7XTIA25J @261
  == 7XQUA25J IF ~InParty("QUAYLE") InMyArea("QUAYLE") !StateCheck("QUAYLE",CD_STATE_NOTVALID)~ THEN @265
END
...
== 7XQUA25J IF ~InParty("QUAYLE") InMyArea("QUAYLE") !StateCheck("QUAYLE",CD_STATE_NOTVALID)~ THEN @285
== 7XTIA25J IF ~InParty("TIAX") InMyArea("TIAX") !StateCheck("TIAX",CD_STATE_NOTVALID)~ THEN @286
END

INTERJECT_COPY_TRANS SOLAR 11 7xTiaxSOLAR-11
== 7XTIA25J IF ~InParty("TIAX") InMyArea("TIAX") !StateCheck("TIAX",CD_STATE_NOTVALID)~ THEN @287
== SOLAR @288
END

INTERJECT_COPY_TRANS SAREV25A 8 7xTiaxSAREV25A-8
== 7XTIA25J IF ~InParty("TIAX") InMyArea("TIAX") !StateCheck("TIAX",CD_STATE_NOTVALID)~ THEN @289
== SAREV25A @290
END

INTERJECT_COPY_TRANS 25SPELL 8 7xTiaxSPELL-8
== 7XTIA25J IF ~InParty("TIAX") InMyArea("TIAX") !StateCheck("TIAX",CD_STATE_NOTVALID)~ THEN @291
== 25SPELL @292
== 7XTIA25J @293
== 25SPELL @294
== 7XTIA25J @295
