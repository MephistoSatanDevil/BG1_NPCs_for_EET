...
IF WEIGHT #-10 ~InParty("XZAR")InParty("MONTARON")!StateCheck("MONTARON",CD_STATE_NOTVALID)~ THEN BEGIN MQFIRE2-1
SAY @3
IF ~~ THEN EXTERN ~7XMONTJ~ MQFIRE2-2
END


IF WEIGHT #-10 ~!InParty("XZAR")InParty("MONTARON")!StateCheck("MONTARON",CD_STATE_NOTVALID)~ THEN BEGIN MQFIRE2-1b
SAY @4
IF ~~ THEN EXTERN ~7XMONTJ~ MQFIRE2-2
END
...
APPEND BERINVAR
IF WEIGHT #-10~OR(2)InParty("XZAR")InParty("MONTARON")~ THEN BEGIN BerinvarAttack
SAY @7
...
APPEND MERONIA
IF WEIGHT #-10~OR(2)InParty("XZAR")InParty("MONTARON")~ THEN BEGIN MERONIAAttack
SAY @8
IF ~~ THEN DO ~ActionOverride("PACE",Enemy())
...
APPEND PACE
IF WEIGHT #-10~OR(2)InParty("XZAR")InParty("MONTARON")~ THEN BEGIN PaceAttack
SAY @9
