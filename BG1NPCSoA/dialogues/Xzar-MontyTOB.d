...
IF ~InParty("XZAR")~ THEN REPLY @0 GOTO XZAR1Volo
END
...
=
@2
== 7XXZA25J IF ~InParty("XZAR")~ THEN @3
EXTERN SARVOLO 9
...
THEN
  REPLY @4
    DO ~CreateVisualEffect("SPPORTAL",[1999.1218])
     ...
     SetGlobal("MONTISummonedTOB","GLOBAL",1) SmallWait(10) ActionOverride("MONTARON",StartDialogNoSet([PC]))~	 
EXIT
END
...
!StateCheck("XZAR",CD_STATE_NOTVALID)InParty("XZAR") InMyArea("XZAR")
...
CHAIN IF ~InParty("MONTARON") InMyArea("MONTARON")!StateCheck("MONTARON",CD_STATE_NOTVALID)
InParty("XZAR") InMyArea("XZAR")!StateCheck("XZAR",CD_STATE_NOTVALID)Global("MONTIXzarToB","GLOBAL",0)~ THEN ~B7XXZA25~ MontyXzarToB1
@55
=
...
CHAIN IF ~InParty("MONTARON") InMyArea("MONTARON")!StateCheck("MONTARON",CD_STATE_NOTVALID)
InParty("XZAR") InMyArea("XZAR")!StateCheck("XZAR",CD_STATE_NOTVALID)Global("MONTIXzarToB","GLOBAL",1)~ THEN ~B7XMON25~ MontyXzarToB2
@64
=
...
CHAIN IF ~InParty("MONTARON") InMyArea("MONTARON")!StateCheck("MONTARON",CD_STATE_NOTVALID)
InParty("XZAR") InMyArea("XZAR")!StateCheck("XZAR",CD_STATE_NOTVALID)Global("MONTIXzarToB","GLOBAL",2)~ THEN ~B7XMON25~ MontyXzarToB3
@70
=
...
CHAIN IF ~InParty("MONTARON") InMyArea("MONTARON")!StateCheck("MONTARON",CD_STATE_NOTVALID)
InParty("XZAR") InMyArea("XZAR")!StateCheck("XZAR",CD_STATE_NOTVALID)Global("MONTIXzarToB","GLOBAL",3)~ THEN ~B7XXZA25~ MontyXzarToB4
...
== 7XMON25J IF ~InParty("MONTARON") InMyArea("MONTARON")!StateCheck("MONTARON",CD_STATE_NOTVALID)~ THEN
@99
END
...
INTERJECT_COPY_TRANS3 FINMEL01 0 montyxzarFINMEL01-0
  == 7XMON25J  IF ~InParty("MONTARON") InMyArea("MONTARON") !StateCheck("MONTARON",CD_STATE_NOTVALID)~ THEN @127
  == FINMEL01 IF ~InParty("MONTARON") InMyArea("MONTARON") !StateCheck("MONTARON",CD_STATE_NOTVALID)~ THEN @128
  == 7XXZA25J IF ~InParty("XZAR") InMyArea("XZAR") !StateCheck("XZAR",CD_STATE_NOTVALID) InParty("MONTARON") InMyArea("MONTARON") !StateCheck("MONTARON",CD_STATE_NOTVALID)~ THEN @129
  == 7XXZA25J IF ~InParty("XZAR") InMyArea("XZAR") !StateCheck("XZAR",CD_STATE_NOTVALID) OR(2) !InParty("MONTARON") StateCheck("MONTARON",CD_STATE_NOTVALID)~ THEN @131
  == FINMEL01 IF ~InParty("XZAR") InMyArea("XZAR") !StateCheck("XZAR",CD_STATE_NOTVALID)~ THEN @130
END

INTERJECT_COPY_TRANS3 FINSOL01 27 montyxzarFINSOL01-27
  == 7XXZA25J IF ~InParty("XZAR") !StateCheck("XZAR",CD_STATE_NOTVALID)~ THEN @163
  == 7XMON25J  IF ~InParty("MONTARON") !StateCheck("MONTARON",CD_STATE_NOTVALID)~ THEN @133 DO ~ActionOverride(Player1,SetDialog("PLAYER1"))~
  = @134
  == PLAYER1  IF ~InParty("MONTARON") !StateCheck("MONTARON",CD_STATE_NOTVALID) Global("MontyRomanceActive","GLOBAL",2)~ THEN @135
  == 7XMON25J  IF ~InParty("MONTARON") !StateCheck("MONTARON",CD_STATE_NOTVALID) Global("MontyRomanceActive","GLOBAL",2)~ THEN @136
  == PLAYER1  IF ~InParty("MONTARON") !StateCheck("MONTARON",CD_STATE_NOTVALID) Global("MontyRomanceActive","GLOBAL",2)~ THEN @137
  == FINSOL01 IF ~InParty("MONTARON") !StateCheck("MONTARON",CD_STATE_NOTVALID) Global("MontyRomanceActive","GLOBAL",2)~ THEN @139 
END

INTERJECT_COPY_TRANS SOLAR 13 xzarSOLAR-13
 == 7XXZA25J IF ~InParty("XZAR") InMyArea("XZAR") !StateCheck("XZAR",CD_STATE_NOTVALID)~ THEN @158
 =@159
END

INTERJECT_COPY_TRANS3 ILLASERA 5 xzarILLASERA-5
 == 7XXZA25J IF ~InParty("XZAR") !StateCheck("XZAR",CD_STATE_NOTVALID)~ THEN @160
 =@161
 == 7XMON25J  IF ~InParty("MONTARON") !StateCheck("MONTARON",CD_STATE_NOTVALID) InParty("XZAR") !StateCheck("XZAR",CD_STATE_NOTVALID)~ THEN @162
 == EDWIN25J  IF ~InParty("Edwin") !StateCheck("Edwin",CD_STATE_NOTVALID) InParty("XZAR") !StateCheck("XZAR",CD_STATE_NOTVALID) OR(2) !InParty("MONTARON") StateCheck("MONTARON",CD_STATE_NOTVALID)~ THEN @162
END


INTERJECT_COPY_TRANS CHALSP01 0 xzarCHALSP01-0
 == 7XXZA25J IF ~InParty("XZAR") !StateCheck("XZAR",CD_STATE_NOTVALID)~ THEN @164
 == 7XMON25J  IF ~InParty("MONTARON") !StateCheck("MONTARON",CD_STATE_NOTVALID) InParty("XZAR") !StateCheck("XZAR",CD_STATE_NOTVALID)~ THEN @165
END

INTERJECT_COPY_TRANS HGNYA01 15 xzarHGNYA01-15
 == 7XXZA25J IF ~InParty("XZAR") !StateCheck("XZAR",CD_STATE_NOTVALID)~ THEN @166
END
...
EXTEND_BOTTOM SARVOLO 9
IF ~InParty("MONTARON")~ THEN REPLY @123 GOTO MONTVolo
END
...
=
@125
== 7XMON25J IF ~InParty("MONTARON")~ THEN @126
EXTERN SARVOLO 9
...
INTERJECT_COPY_TRANS BOTSMITH 1 xzarBOTSMITH-1
 == 7XMON25J  IF ~InParty("MONTARON") !StateCheck("MONTARON",CD_STATE_NOTVALID)~ THEN @167
 =@168
== 7XXZA25J IF ~InParty("XZAR") !StateCheck("XZAR",CD_STATE_NOTVALID)~ THEN @169
== 7XMON25J  IF ~InParty("MONTARON") !StateCheck("MONTARON",CD_STATE_NOTVALID)~ THEN @170
END

INTERJECT_COPY_TRANS CHALSP01 4 MontyCHALSP01-4
== 7XMON25J  IF ~InParty("MONTARON") !StateCheck("MONTARON",CD_STATE_NOTVALID)~ THEN @171
END