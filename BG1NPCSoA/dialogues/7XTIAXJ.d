...
// Water Gardens Talk
IF WEIGHT #-10 ~AreaCheck("ARBGX2") InParty("TIAX")!StateCheck("TIAX",CD_STATE_NOTVALID) Global("TiaxARBGX2","ARBGX2",2)~ THEN 7xTiaxWaterGardens
SAY @183
=@184
...
== 7XTIAXJ IF ~!StateCheck("TIAX",CD_STATE_NOTVALID) InParty("TIAX")~ THEN
@5 
END
...
== 7XTIAXJ IF ~See("TIAX") !StateCheck("TIAX",CD_STATE_NOTVALID) InParty("TIAX")~ THEN 
@19
END
...
== 7XTIAXJ IF ~!StateCheck("TIAX",CD_STATE_NOTVALID)See("TIAX")InParty("TIAX")~ THEN 
@29
END
...
== 7XTIAXJ IF ~!StateCheck("TIAX",CD_STATE_NOTVALID)See("TIAX")InParty("TIAX")~ THEN @35
END

I_C_T CIRCG1 4 Tiax-CircusGuard2
== 7XTIAXJ IF ~See("TIAX") !StateCheck("TIAX",CD_STATE_NOTVALID) InParty("TIAX")~ THEN @36
END

I_C_T CIRCG1 10 Tiax-CircusGuard3
== 7XTIAXJ IF ~See("TIAX") !StateCheck("TIAX",CD_STATE_NOTVALID) InParty("TIAX")~ THEN @37
END

I_C_T CIRCG1 5 Tiax-CircusGuard4
== 7XTIAXJ IF ~See("TIAX") !StateCheck("TIAX",CD_STATE_NOTVALID) InParty("TIAX")~ THEN @38
== CIRCG1 IF ~See("TIAX") !StateCheck("TIAX",CD_STATE_NOTVALID) InParty("TIAX")~ THEN @39
== 7XTIAXJ IF ~See("TIAX") !StateCheck("TIAX",CD_STATE_NOTVALID) InParty("TIAX")~ THEN @40
END

I_C_T KALAH2 5 Tiax-KalahDeath
== 7XTIAXJ IF ~See("TIAX") !StateCheck("TIAX",CD_STATE_NOTVALID) InParty("TIAX")~ THEN @41
END

I_C_T KGENIE1 0 TiaxCircusGenie1
== 7XTIAXJ IF ~InParty("TIAX")!StateCheck("TIAX",CD_STATE_NOTVALID)InMyArea("TIAX")~ THEN 
@42
== KGENIE1 @43
=
@44
...
== 7XTIAXJ IF ~See("TIAX") !StateCheck("TIAX",CD_STATE_NOTVALID) InParty("TIAX")~ THEN @49
=
@50
=
@51
...
== 7XTIAXJ IF ~See("TIAX") !StateCheck("TIAX",CD_STATE_NOTVALID) InParty("TIAX")~ THEN @52
== KALAH IF ~See("TIAX") !StateCheck("TIAX",CD_STATE_NOTVALID) InParty("TIAX")~ THEN @53
=
@54
== 7XTIAXJ IF ~See("TIAX") !StateCheck("TIAX",CD_STATE_NOTVALID) InParty("TIAX")~ THEN @55
=
@56 
=
@57 
...
== 7XTIAXJ IF ~See("TIAX") !StateCheck("TIAX",CD_STATE_NOTVALID) InParty("TIAX")~ THEN @58
=
@59
END
...
== 7XTIAXJ IF ~See("TIAX") !StateCheck("TIAX",CD_STATE_NOTVALID) InParty("TIAX")~ THEN @62
=
@63
END

I_C_T AERIE 50 TiaxAerieQuayle
== 7XTIAXJ IF ~See("TIAX") !StateCheck("TIAX",CD_STATE_NOTVALID) InParty("TIAX")~ THEN @64
END

I_C_T AERIEJ 4 QuayleDeadComment
== 7XTIAXJ IF ~See("TIAX") !StateCheck("TIAX",CD_STATE_NOTVALID) InParty("TIAX")~ THEN @65
END
...
== 7XTIAXJ IF ~See("TIAX") !StateCheck("TIAX",CD_STATE_NOTVALID) InParty("TIAX")~ THEN @66
END


I_C_T AERIE 3 TiaxAerieMistake
== 7XTIAXJ IF ~See("TIAX") !StateCheck("TIAX",CD_STATE_NOTVALID) InParty("TIAX")~ THEN @67
=
@68
END
...
== 7XTIAXJ IF ~!StateCheck("TIAX",CD_STATE_NOTVALID) InParty("TIAX")~ THEN @69
END

I_C_T BOY1 5 TiaxCircusBoy1-5
== 7XTIAXJ IF ~!StateCheck("TIAX",CD_STATE_NOTVALID) InParty("TIAX")~ THEN @70
END


I_C_T VICG1 1 TiaxVICG1
  == 7XTIAXJ   IF ~!StateCheck("TIAX",CD_STATE_NOTVALID) InParty("TIAX")~ THEN @71
=
@72
END
...
I_C_T VICONI 2 TIAXVICG2
  == 7XTIAXJ   IF ~!StateCheck("TIAX",CD_STATE_NOTVALID) InParty("TIAX")~ THEN @73
  == VICONI IF ~!StateCheck("TIAX",CD_STATE_NOTVALID) InParty("TIAX")~ THEN @74
  == 7XTIAXJ IF ~!StateCheck("TIAX",CD_STATE_NOTVALID) InParty("TIAX")~ THEN @75
END


I_C_T KGENIE1 3 TiaxGenieGuess
  == 7XTIAXJ  IF ~!StateCheck("TIAX",CD_STATE_NOTVALID) InParty("TIAX")~ THEN @76
END


I_C_T HELLJON 1 TiaxJon
  == 7XTIAXJ   IF ~!StateCheck("TIAX",CD_STATE_NOTVALID) InParty("TIAX")~ THEN @77  
== HELLJON IF ~!StateCheck("TIAX",CD_STATE_NOTVALID) InParty("TIAX")~ THEN @78
END
...
== 7XTIAXJ   IF ~!StateCheck("TIAX",CD_STATE_NOTVALID) InParty("TIAX")~ THEN @84
== TIRLANA @85 
== 7XTIAXJ IF ~!StateCheck("TIAX",CD_STATE_NOTVALID) InParty("TIAX")~ THEN @86
== TIRLANA @87
END

I_C_T PPTIAX 6 TiaxTiax6
  == 7XTIAXJ   IF ~!StateCheck("TIAX",CD_STATE_NOTVALID) InParty("TIAX")~ THEN @88 
END
...
I_C_T SAILFIN 0 TiaxSAILFIN
  == 7XTIAXJ   IF ~!StateCheck("TIAX",CD_STATE_NOTVALID) InParty("TIAX")~ THEN @90
END


I_C_T SAILJOS 1 TiaxSAILJOS
  == 7XTIAXJ   IF ~!StateCheck("TIAX",CD_STATE_NOTVALID) InParty("TIAX")~ THEN @91
END
...
I_C_T VICONI 10 TIAXVICONI-10
  == 7XTIAXJ IF ~!StateCheck("TIAX",CD_STATE_NOTVALID) InParty("TIAX")~ THEN @103 
  == VICONI @104
  == 7XTIAXJ @105 
END

I_C_T DELON 6 TIAXDELON-6
== 7XTIAXJ IF ~!StateCheck("TIAX",CD_STATE_NOTVALID)InParty("TIAX")InMyArea("TIAX")~ THEN
@106
== DELON @107
END
...
== PLAYER1 IF ~!StateCheck("TIAX",CD_STATE_NOTVALID)InParty("TIAX")~ THEN
@121
END
...
== 7XTIAXJ IF ~!StateCheck("TIAX",CD_STATE_NOTVALID)InParty("TIAX")~ THEN @139
=
@140
END
...
== 7XTIAXJ IF ~GlobalLT("Chapter","GLOBAL",%bg2_chapter_8%) InParty("TIAX") InMyArea("TIAX") !StateCheck("TIAX",CD_STATE_NOTVALID)~ THEN @178
== GORODR1 @193
END

INTERJECT_COPY_TRANS BYLANNA 26 TiaxBYLANNA-26
== 7XTIAXJ IF ~InParty("TIAX") InMyArea("TIAX") !StateCheck("TIAX",CD_STATE_NOTVALID)~ THEN @179
END

INTERJECT_COPY_TRANS PPIRENI1 32 TiaxPPIRENI1-32
== 7XTIAXJ IF ~InParty("TIAX") InMyArea("TIAX") !StateCheck("TIAX",CD_STATE_NOTVALID)~ THEN @180
== PPIRENI1 @181
END

INTERJECT_COPY_TRANS PPSAEM2 4 TiaxPPSAEM2-4
== 7XTIAXJ IF ~InParty("TIAX") InMyArea("TIAX") !StateCheck("TIAX",CD_STATE_NOTVALID)~ THEN @182
END

INTERJECT_COPY_TRANS HABREGA 0 TiaxHABREGA-0
== 7XTIAXJ IF ~InParty("TIAX") InMyArea("TIAX") !StateCheck("TIAX",CD_STATE_NOTVALID)~ THEN @185
== HABREGA @186
END

INTERJECT_COPY_TRANS CELOGAN 48 TiaxCELOGAN-48
== 7XTIAXJ IF ~InParty("TIAX") InMyArea("TIAX") !StateCheck("TIAX",CD_STATE_NOTVALID)~ THEN @187
END
...
== 7XTIAXJ IF ~InParty("TIAX") InMyArea("TIAX") !StateCheck("TIAX",CD_STATE_NOTVALID)~ THEN @188
END

INTERJECT_COPY_TRANS MURDGIRL 0 TiaxMURDGIRL-0
== 7XTIAXJ IF ~InParty("TIAX") InMyArea("TIAX") !StateCheck("TIAX",CD_STATE_NOTVALID)~ THEN @189
== MURDGIRL @190
END
...
== 7XTIAXJ IF ~InParty("TIAX") InMyArea("TIAX") !StateCheck("TIAX",CD_STATE_NOTVALID)~ THEN @191
== PWARDEN @169
END
...
== 7XTIAXJ IF ~InParty("TIAX") InMyArea("TIAX") !StateCheck("TIAX",CD_STATE_NOTVALID)~ THEN @21
END

INTERJECT_COPY_TRANS SHTHDR01 3 TiaxSHTHDR01-3
== 7XTIAXJ IF ~InParty("TIAX") InMyArea("TIAX") !StateCheck("TIAX",CD_STATE_NOTVALID)~ THEN @192
END

INTERJECT_COPY_TRANS C6BODHI 0 TiaxC6BODHI-0
== 7XTIAXJ IF ~InParty("TIAX") InMyArea("TIAX") !StateCheck("TIAX",CD_STATE_NOTVALID)~ THEN @194
== C6BODHI @195
END

INTERJECT_COPY_TRANS C6BODHI 5 TiaxC6BODHI-5
== 7XTIAXJ IF ~InParty("TIAX") InMyArea("TIAX") !StateCheck("TIAX",CD_STATE_NOTVALID)~ THEN @196
== C6BODHI @197
END

INTERJECT_COPY_TRANS SUELLE2 12 TiaxSUELLE2-12
== 7XTIAXJ IF ~InParty("TIAX") InMyArea("TIAX") !StateCheck("TIAX",CD_STATE_NOTVALID)~ THEN @198
== SUELLE2 @199
END

INTERJECT_COPY_TRANS IF_FILE_EXISTS NEERA 21 TiaxNEERA-21
== 7XTIAXJ IF ~InParty("TIAX") InMyArea("TIAX") !StateCheck("TIAX",CD_STATE_NOTVALID)~ THEN @200
END

INTERJECT_COPY_TRANS IF_FILE_EXISTS OHNKNOCK 2 TiaxOHNKNOCK-2
== 7XTIAXJ IF ~InParty("TIAX") InMyArea("TIAX") !StateCheck("TIAX",CD_STATE_NOTVALID)~ THEN @201
== OHNKNOCK @202
== 7XTIAXJ @203
== OHNKNOCK @204
END
...
== 7XTIAXJ IF ~InParty("TIAX") InMyArea("TIAX") !StateCheck("TIAX",CD_STATE_NOTVALID)~ THEN @205
== WILSON @206
END

INTERJECT_COPY_TRANS IF_FILE_EXISTS OHNMERET 16 TiaxOHNMERET-16
== 7XTIAXJ IF ~InParty("TIAX") InMyArea("TIAX") !StateCheck("TIAX",CD_STATE_NOTVALID)~ THEN @207
== OHNMERET @208
END

I_C_T BODHI 34 TiaxBodhi34
== 7XTIAXJ IF ~InParty("TIAX") InMyArea("TIAX") !StateCheck("TIAX",CD_STATE_NOTVALID)~ THEN @209
== BODHI @210
END

I_C_T PPIRENI2 35 TiaxPPIRENI2-35
== 7XTIAXJ IF ~InParty("TIAX") InMyArea("TIAX") !StateCheck("TIAX",CD_STATE_NOTVALID)~ THEN @211
END

I_C_T UDARDUL 15 TiaxUDARDUL15
== 7XTIAXJ IF ~InParty("TIAX") InMyArea("TIAX") !StateCheck("TIAX",CD_STATE_NOTVALID)~ THEN @212
== UDARDUL @213
END

I_C_T ANTENOS 4 TiaxANTENOS4
== 7XTIAXJ IF ~InParty("TIAX") InMyArea("TIAX") !StateCheck("TIAX",CD_STATE_NOTVALID)~ THEN @214
END

INTERJECT_COPY_TRANS GORODR1 4 TiaxGORODR1-4
== 7XTIAXJ IF ~GlobalLT("Chapter","GLOBAL",%bg2_chapter_8%) InParty("TIAX") InMyArea("TIAX") !StateCheck("TIAX",CD_STATE_NOTVALID)~ THEN @215
== GORODR1 @216
END


INTERJECT_COPY_TRANS BNOBLE1 6 TiaxBNOBLE1-6
== 7XTIAXJ IF ~InParty("TIAX") InMyArea("TIAX") !StateCheck("TIAX",CD_STATE_NOTVALID)~ THEN @217
== BNOBLE1 @218
== BNOBLE2 @219
== BNOBLE1 @220
== BNOBLE2 @221
...
== 7XTIAXJ IF ~InParty("TIAX") InMyArea("TIAX") !StateCheck("TIAX",CD_STATE_NOTVALID)~ THEN @224
== NEERA @225
END

INTERJECT_COPY_TRANS DRAGBLAC 2 TiaxDRAGBLAC-2
== 7XTIAXJ IF ~InParty("TIAX") InMyArea("TIAX") !StateCheck("TIAX",CD_STATE_NOTVALID)~ THEN @226
== DRAGBLAC @227
END
