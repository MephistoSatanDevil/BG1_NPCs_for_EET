...
SmallWait(10) 
ActionOverride("FALDORN",StartDialogNoSet([PC]))~ GOTO 8
END
...
IF ~InParty("FALDORN")~ THEN REPLY @25 GOTO FaldornVolo
END
...
=
@27
== 7XFAL25J IF ~InParty("FALDORN") InMyArea("FALDORN") !StateCheck("FALDORN",CD_STATE_NOTVALID)~ THEN @28
EXTERN SARVOLO 9

INTERJECT_COPY_TRANS FINMEL01 6 7XFAL25JFINMEL01-6
  == 7XFAL25J  IF ~InParty("FALDORN") InMyArea("FALDORN") !StateCheck("FALDORN",CD_STATE_NOTVALID)~ THEN @30
  == FINMEL01 IF ~InParty("FALDORN") InMyArea("FALDORN") !StateCheck("FALDORN",CD_STATE_NOTVALID)~ THEN @31
  == 7XFAL25J  IF ~InParty("FALDORN") InMyArea("FALDORN") !StateCheck("FALDORN",CD_STATE_NOTVALID)~ THEN @32
  == FINMEL01 IF ~InParty("FALDORN") InMyArea("FALDORN") !StateCheck("FALDORN",CD_STATE_NOTVALID)~ THEN @33
END

INTERJECT_COPY_TRANS FINSOL01 27 7XFAL25JFINSOL01-27
  == 7XFAL25J  IF ~InParty("FALDORN") InMyArea("FALDORN") !StateCheck("FALDORN",CD_STATE_NOTVALID)~ THEN @34
END

INTERJECT_COPY_TRANS FINSOL01 31 7XFAL25JFINSOL01-31
  == 7XFAL25J  IF ~InParty("FALDORN") InMyArea("FALDORN") !StateCheck("FALDORN",CD_STATE_NOTVALID)~ THEN @35
END
...
INTERJECT_COPY_TRANS AMSAEMON 0 7XFAL25JAMSAEMON-0
  == 7XFAL25J  IF ~InParty("FALDORN") InMyArea("FALDORN") !StateCheck("FALDORN",CD_STATE_NOTVALID)~ THEN @40
END
