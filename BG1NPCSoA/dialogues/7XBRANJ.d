...
== 7XBRANJ IF ~InParty("BRANWEN")!StateCheck("BRANWEN",CD_STATE_NOTVALID)~ THEN
 @0
END
...
Name("BRANWEN",LastTalkedToBy)~ THEN SALVANAS branwenTALK
@17
== 7XBRANJ
@18
== SALVANAS @19
...
== 7XBRANJ IF ~InParty("BRANWEN")!StateCheck("BRANWEN",STATE_SLEEPING)!StateCheck("BRANWEN",CD_STATE_NOTVALID)~ THEN
@24
== ANOMENJ
@25
END
...
== 7XBRANJ IF ~InParty("BRANWEN")!StateCheck("BRANWEN",STATE_SLEEPING)!StateCheck("BRANWEN",CD_STATE_NOTVALID)~ THEN @29
=
@30 
== PWAUK2 @31
END
...
== 7XBRANJ IF ~InParty("BRANWEN")!StateCheck("BRANWEN",STATE_SLEEPING)!StateCheck("BRANWEN",CD_STATE_NOTVALID)~ THEN @32 
== PROPHET1 @33
== 7XBRANJ IF ~InParty("BRANWEN")!StateCheck("BRANWEN",STATE_SLEEPING)!StateCheck("BRANWEN",CD_STATE_NOTVALID)~ THEN @34 
== PROPHET1 @35
=
@36
== 7XBRANJ @37
...
== 7XBRANJ IF ~InParty("BRANWEN")!StateCheck("BRANWEN",STATE_SLEEPING)!StateCheck("BRANWEN",CD_STATE_NOTVALID)~ THEN @40
== PROPHET1 @41
=
@42
== 7XBRANJ IF ~InParty("BRANWEN")!StateCheck("BRANWEN",STATE_SLEEPING)!StateCheck("BRANWEN",CD_STATE_NOTVALID)~ THEN @43
=
@44 
== PROPHET1 @45
=
...
I_C_T PROPHET1 2 BranwenPROPHET1-3
  == 7XBRANJ   IF ~InParty("BRANWEN")!StateCheck("BRANWEN",STATE_SLEEPING)!StateCheck("BRANWEN",CD_STATE_NOTVALID)~ THEN @48 
== PROPHET1 @49
== 7XBRANJ IF ~InParty("BRANWEN")!StateCheck("BRANWEN",STATE_SLEEPING)!StateCheck("BRANWEN",CD_STATE_NOTVALID)~ THEN @50 
== PROPHET1 @51
=
@52
== 7XBRANJ IF ~InParty("BRANWEN")!StateCheck("BRANWEN",STATE_SLEEPING)!StateCheck("BRANWEN",CD_STATE_NOTVALID)~ THEN @53
=
@54
END

I_C_T ACOLYTE1 0 BranAcolyte1
== 7XBRANJ IF ~InParty("BRANWEN")!StateCheck("BRANWEN",CD_STATE_NOTVALID)~ THEN @55
== ACOLYTE1 @56
=
@57
== 7XBRANJ @58
...
I_C_T ACOLYTE2 0 BranAcolyte2
  == 7XBRANJ IF ~InParty("BRANWEN")
!StateCheck("BRANWEN",CD_STATE_NOTVALID)~ THEN
@63
== ACOLYTE2 @64
== 7XBRANJ IF ~InParty("BRANWEN")
!StateCheck("BRANWEN",CD_STATE_NOTVALID)~ THEN
...
I_C_T CSGAAL 1 BranwengAAL1
  == 7XBRANJ   IF ~InParty("BRANWEN")!StateCheck("BRANWEN",CD_STATE_NOTVALID)~ THEN @76
=
@77 
END

I_C_T CSGAAL 3 BranwengAAL2
  == 7XBRANJ   IF ~InParty("BRANWEN")!StateCheck("BRANWEN",CD_STATE_NOTVALID)~ THEN @78 
END
...
I_C_T CSGAAL 11 BranwengAAL3
  == 7XBRANJ   IF ~InParty("BRANWEN")!StateCheck("BRANWEN",CD_STATE_NOTVALID)~ THEN @86 
END
...
== 7XBRANJ
IF ~InParty("BRANWEN")
!StateCheck("BRANWEN",STATE_SLEEPING)!StateCheck("BRANWEN",CD_STATE_NOTVALID)~ THEN
@87
END
...
== PLAYER1 IF ~InParty("BRANWEN")~ THEN
@144
END
...
I_C_T BRAT1 10 BranwenBrat1
  == 7XBRANJ   IF ~InParty("BRANWEN")!StateCheck("BRANWEN",STATE_SLEEPING)!StateCheck("BRANWEN",CD_STATE_NOTVALID)~ THEN @157 
END



I_C_T DAWNMAS 0 BranwenDAWNMAS
  == 7XBRANJ   IF ~InParty("BRANWEN")!StateCheck("BRANWEN",STATE_SLEEPING)!StateCheck("BRANWEN",CD_STATE_NOTVALID)~ THEN @158 
== DAWNMAS @159
 == 7XBRANJ   IF ~InParty("BRANWEN")!StateCheck("BRANWEN",STATE_SLEEPING)!StateCheck("BRANWEN",CD_STATE_NOTVALID)~ THEN @160
== DAWNMAS @161
== 7XBRANJ   IF ~InParty("BRANWEN")!StateCheck("BRANWEN",STATE_SLEEPING)!StateCheck("BRANWEN",CD_STATE_NOTVALID)~ THEN @162
== DAWNMAS @163
END


INTERJECT_COPY_TRANS PROPHET2 0 BranwenPROPHET2
== 7XBRANJ IF ~InParty("BRANWEN")!StateCheck("BRANWEN",STATE_SLEEPING)!StateCheck("BRANWEN",CD_STATE_NOTVALID)~ THEN @164
END

INTERJECT_COPY_TRANS PROPHET3 0 BranwenPROPHET3
== 7XBRANJ IF ~InParty("BRANWEN")!StateCheck("BRANWEN",STATE_SLEEPING)!StateCheck("BRANWEN",CD_STATE_NOTVALID)~ THEN @165
END

INTERJECT_COPY_TRANS PROPHET3 1 BranwenPROPHET3-1
== 7XBRANJ IF ~InParty("BRANWEN")!StateCheck("BRANWEN",STATE_SLEEPING)!StateCheck("BRANWEN",CD_STATE_NOTVALID)~ THEN @166
END

INTERJECT_COPY_TRANS PROPHET4 0 BranwenPROPHET4
== 7XBRANJ IF ~InParty("BRANWEN")!StateCheck("BRANWEN",STATE_SLEEPING)!StateCheck("BRANWEN",CD_STATE_NOTVALID)~ THEN @167
END


INTERJECT_COPY_TRANS PROPHET4 1 BranwenPROPHET4-1
== 7XBRANJ IF ~InParty("BRANWEN")!StateCheck("BRANWEN",STATE_SLEEPING)!StateCheck("BRANWEN",CD_STATE_NOTVALID)~ THEN @168 
END

INTERJECT_COPY_TRANS PROPHET4 2 BranwenPROPHET4-2
== 7XBRANJ IF ~InParty("BRANWEN")!StateCheck("BRANWEN",STATE_SLEEPING)!StateCheck("BRANWEN",CD_STATE_NOTVALID)~ THEN @169
END

INTERJECT_COPY_TRANS PROPHET2 11 BranwenPROPHET2-1
== 7XBRANJ IF ~InParty("BRANWEN")!StateCheck("BRANWEN",STATE_SLEEPING)!StateCheck("BRANWEN",CD_STATE_NOTVALID)~ THEN @170
=
@171
END
