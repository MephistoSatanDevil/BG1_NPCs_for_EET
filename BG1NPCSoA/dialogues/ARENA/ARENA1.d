...
IF ~Global("ARENAFIGHT","GLOBAL",0)!InParty("SHARTEEL")~ THEN BEGIN INTRO1
SAY @0
=
@1
=
...
IF ~Global("ARENAFIGHT","GLOBAL",0)OR(2)IsGabber("SHARTEEL")InParty("SHARTEEL")~ THEN BEGIN SharCHALLENGE1-a
SAY @3
