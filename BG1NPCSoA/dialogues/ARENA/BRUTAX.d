...
IF ~Global("BRUTAX","GLOBAL",0)InParty("SHARTEEL")~ THEN BEGIN INTRO1b
SAY @0
IF ~~ THEN DO ~SetGlobal("BRUTAX","GLOBAL",1)~ EXTERN ~7XsharJ~ BRUTAX1-1
END

IF ~Global("BRUTAX","GLOBAL",0)IsGabber("SHARTEEL")~ THEN BEGIN INTRO1c
SAY @0
IF ~~ THEN DO ~SetGlobal("BRUTAX","GLOBAL",1)~ EXTERN ~7XsharJ~ BRUTAX1-1
END

IF ~Global("BRUTAX","GLOBAL",0)!InParty("SHARTEEL")~ THEN BEGIN INTRO1
SAY @1
=
@2
IF ~~ THEN EXIT
...
IF ~Global("BRUTAX","GLOBAL",1)IsGabber("SHARTEEL")~ THEN BEGIN SharTeelBrutax
SAY @6
IF ~~ THEN EXTERN ~7XsharJ~ SharTeelBrutax2
END

IF ~Global("BRUTAX","GLOBAL",1)IsGabber("SHARTEEL")~ THEN BEGIN SharTeelBrutax3
SAY @7
=
@8
