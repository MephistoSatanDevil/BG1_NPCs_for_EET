...
IF ~InParty("SHARTEEL")!StateCheck("SHARTEEL",CD_STATE_NOTVALID)~ EXTERN 7XsharJ SharAerieInter1
END
...
== 7XsharJ IF ~InParty("SHARTEEL")!StateCheck("SHARTEEL",CD_STATE_NOTVALID)InMyArea("SHARTEEL")~ THEN
@10
== UDSOLA01 @11
== 7XsharJ  @12
EXTERN UDSOLA01 57
...
== 7XsharJ IF ~InParty("SHARTEEL")!StateCheck("SHARTEEL",CD_STATE_NOTVALID)InMyArea("SHARTEEL")~ THEN @32
== NEB @34
END
...
== 7XsharJ IF ~InParty("SHARTEEL")!StateCheck("SHARTEEL",CD_STATE_NOTVALID)InMyArea("SHARTEEL")~ THEN @40
=@41
== EMBARL @262
END
...
== 7XsharJ IF ~InParty("SHARTEEL")!StateCheck("SHARTEEL",CD_STATE_NOTVALID)~ THEN
  @81
END
...
EXTEND_BOTTOM TRGYP02 2
  IF ~!InPartySlot(LastTalkedToBy,0)Name("SHARTEEL",LastTalkedToBy)~ EXTERN TRGYP02 SharGypsy_0
END
...
== 7XsharJ
IF ~InParty("SHARTEEL")!StateCheck("SHARTEEL",CD_STATE_NOTVALID)~ THEN
@117
END

CHAIN IF WEIGHT #-1 ~InParty("SHARTEEL")!StateCheck("SHARTEEL",CD_STATE_NOTVALID)
Global("sharteel_salvanas","GLOBAL",0) IsGabber("SHARTEEL")~ THEN SALVANAS shar_salvanas
  @118
...
CHAIN IF WEIGHT #-1 ~InParty("SHARTEEL")!StateCheck("SHARTEEL",CD_STATE_NOTVALID) OR(2) Global("HendakReleased","AR0406",3) Global("HendakReleased","AR0406",4) Global("shar_hendak","GLOBAL",0)~ THEN HENDAK Shar_hendak1
  @130
=
@131
...
CHAIN
IF WEIGHT #-1 ~InParty("SHARTEEL")!StateCheck("SHARTEEL",CD_STATE_NOTVALID)
    RandomNum(2,1)
...
INTERJECT UDDROW16 44 SharDrowdDuels 
 == 7XsharJ IF ~InParty("SHARTEEL")!StateCheck("SHARTEEL",CD_STATE_NOTVALID)Global("SharDrowDuels","GLOBAL",0)
...
APPEND BELMIN
  IF WEIGHT #-1 ~RandomNum(2,1)
      ...
      InParty("SHARTEEL")!StateCheck("SHARTEEL",CD_STATE_NOTVALID)~ THEN BEGIN SharBelminTalk
SAY @171
=
@172
=
...
== 7XsharJ IF ~InParty("SHARTEEL")!StateCheck("SHARTEEL",CD_STATE_NOTVALID) OR(3) CLASS([PC], RANGER_ALL) InParty("Minsc") InParty("Valygar")~ THEN @187
END

I_C_T UHMAY01 20 SharArmorCommentNoRanger
== 7XsharJ IF ~InParty("SHARTEEL")!StateCheck("SHARTEEL",CD_STATE_NOTVALID) !CLASS([PC], RANGER_ALL) !InParty("Minsc") !InParty("Valygar")~ THEN @188
END
...
== 7XsharJ IF ~InParty("SHARTEEL")!StateCheck("SHARTEEL",CD_STATE_NOTVALID)~
THEN @228
=
@229
END
...
== 7XsharJ IF ~InParty("SHARTEEL")!StateCheck("SHARTEEL",CD_STATE_NOTVALID)~ THEN @230
END
...
== PLAYER1 IF ~InParty("SHARTEEL")!StateCheck("SHARTEEL",CD_STATE_NOTVALID)~ THEN @237
END
...
EXTEND_BOTTOM TRGYP02 2
IF ~Name("SHARTEEL",LastTalkedToBy(Myself))~
...
I_C_T PLAYER1 25 7xShar_Hell
  == 7XsharJ IF ~InParty("SHARTEEL") !StateCheck("SHARTEEL",CD_STATE_NOTVALID)~ THEN @250
END

I_C_T IF_FILE_EXISTS NEERAJ 512 7xSharNEERAJ-512
== 7XsharJ IF ~InParty("SHARTEEL") !StateCheck("SHARTEEL",CD_STATE_NOTVALID)~ THEN @251
== OHNTELAN @252
== NEERAJ @253
== 7XsharJ @254
END
...
== 7XsharJ IF ~InParty("SHARTEEL") !StateCheck("SHARTEEL",CD_STATE_NOTVALID)~ THEN @255
== UDDOOR01 @256
END
...
INTERJECT_COPY_TRANS UDDROW08 12 7xSharTeelUDDROW08-12
  == 7XsharJ IF ~InParty("SHARTEEL") !StateCheck("SHARTEEL",CD_STATE_NOTVALID)~ THEN @260
  == UDDROW08 @261
END