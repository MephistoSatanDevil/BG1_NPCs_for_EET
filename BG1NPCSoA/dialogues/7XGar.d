...
== 7XGarJ IF ~!StateCheck("GARRICK",STATE_SLEEPING)InParty("GARRICK")!StateCheck("GARRICK",CD_STATE_NOTVALID)~ THEN
 @22
=
@23
END
...
== 7XGarJ
IF ~!StateCheck("GARRICK",STATE_SLEEPING)InParty("GARRICK")!StateCheck("GARRICK",CD_STATE_NOTVALID)~ THEN
@39
END
...
== 7XGarJ
IF ~InParty("GARRICK")
!StateCheck("GARRICK",CD_STATE_NOTVALID)~ THEN
@40
=
@41
END
...
CHAIN IF WEIGHT #-1
~!StateCheck("GARRICK",STATE_SLEEPING)InParty("GARRICK")!StateCheck("GARRICK",CD_STATE_NOTVALID)
InMyArea("GARRICK")
...
== 7XGarJ IF ~!StateCheck("GARRICK",STATE_SLEEPING)InParty("GARRICK")!StateCheck("GARRICK",CD_STATE_NOTVALID)
InMyArea("GARRICK")~ THEN
@67
END
...
== 7XGarJ IF ~InParty("GARRICK") !StateCheck("GARRICK",CD_STATE_NOTVALID)~ THEN @91
== BHCRYPT @690
END
...
== PLAYER1 IF ~InParty("GARRICK")~ THEN
@118
END
...
///////////
APPEND FFCUST09
IF WEIGHT #-10 ~InParty("GARRICK")Global("SILKEFight","GLOBAL",0)
!StateCheck("GARRICK",CD_STATE_NOTVALID)~ THEN BEGIN GarFFCUST09
SAY @137
...
APPEND FFCUST07
IF WEIGHT #-10 ~InParty("GARRICK")Global("SILKEFight","GLOBAL",0)
!StateCheck("GARRICK",CD_STATE_NOTVALID)~ THEN BEGIN GarFFCUST07
SAY @141
=
@142
...
APPEND FFCUST06
IF WEIGHT #-10 ~InParty("GARRICK")Global("SILKEFight","GLOBAL",0)
!StateCheck("GARRICK",CD_STATE_NOTVALID)~ THEN BEGIN GarFFCUST06
SAY @144
...
APPEND FFCUST05
IF WEIGHT #-10 ~InParty("GARRICK")Global("SILKEFight","GLOBAL",0)
!StateCheck("GARRICK",CD_STATE_NOTVALID)~ THEN BEGIN GarFFCUST05
SAY @146
...
APPEND FFCUST04
IF WEIGHT #-10 ~InParty("GARRICK")Global("SILKEFight","GLOBAL",0)
!StateCheck("GARRICK",CD_STATE_NOTVALID)~ THEN BEGIN GarFFCUST04
SAY @148
...
== 7XGarJ IF ~InParty("GARRICK") InMyArea("GARRICK") !StateCheck("GARRICK",CD_STATE_NOTVALID)~ THEN @192
END

INTERJECT_COPY_TRANS BODHI 6 GarrickBODHI-6
== 7XGarJ IF ~InParty("GARRICK") InMyArea("GARRICK") !StateCheck("GARRICK",CD_STATE_NOTVALID)~ THEN @393
END
...
APPEND MURDGIRL
IF WEIGHT #-10 ~InParty("GARRICK")!StateCheck("GARRICK",CD_STATE_NOTVALID) Global("SILKEFight","GLOBAL",0) Global("7xRoseSilkeTalk","AR0500",0)~ THEN BEGIN GarMURDGIRL1
SAY @151
=
@152
...
== 7XGarJ IF ~InParty("GARRICK") !StateCheck("GARRICK",CD_STATE_NOTVALID)~ THEN @187
=@188
== BVICONI IF ~InParty("GARRICK") !StateCheck("GARRICK",CD_STATE_NOTVALID)~ THEN @189
END

INTERJECT_COPY_TRANS SUELLE2 12 GarrickSUELLE2-12
== 7XGarJ IF ~InParty("GARRICK") !StateCheck("GARRICK",CD_STATE_NOTVALID)~ THEN @190
== SUELLE2 @191
END

INTERJECT_COPY_TRANS INSPECT 13 GarrickINSPECT-13
== 7XGarJ IF ~InParty("GARRICK") !StateCheck("GARRICK",CD_STATE_NOTVALID)~ THEN @683
END

INTERJECT_COPY_TRANS PPIRENI1 9 GarrickPPIRENI1-9
== 7XGarJ IF ~InParty("GARRICK") !StateCheck("GARRICK",CD_STATE_NOTVALID)~ THEN @685
END

INTERJECT_COPY_TRANS PLAYER1 5 GarrickPLAYER1-5
== 7XGarJ IF ~InParty("GARRICK") !StateCheck("GARRICK",CD_STATE_NOTVALID)~ THEN @686
END

INTERJECT_COPY_TRANS ISAEA 29 GarrickISAEA-29
== 7XGarJ IF ~InParty("GARRICK") !StateCheck("GARRICK",CD_STATE_NOTVALID)~ THEN @687
END
...
== 7XMONTJ IF ~InParty("MONTARON") !StateCheck("MONTARON",CD_STATE_NOTVALID)~ THEN @485
== EDWINJ IF ~InParty("Edwin") !StateCheck("Edwin",CD_STATE_NOTVALID) OR(2) !InParty("MONTARON") StateCheck("MONTARON",CD_STATE_NOTVALID)~ THEN @485
== KORGANJ IF ~InParty("Korgan") !StateCheck("Korgan",CD_STATE_NOTVALID) OR(2) !InParty("MONTARON") StateCheck("MONTARON",CD_STATE_NOTVALID) OR(2) !InParty("Edwin") StateCheck("Edwin",CD_STATE_NOTVALID)~ THEN @485
== VICONIJ IF ~InParty("Viconia") !StateCheck("Viconia",CD_STATE_NOTVALID) OR(2) !InParty("MONTARON") StateCheck("MONTARON",CD_STATE_NOTVALID) OR(2) !InParty("Edwin") StateCheck("Edwin",CD_STATE_NOTVALID) OR(2) !InParty("Korgan") StateCheck("Korgan",CD_STATE_NOTVALID)~ THEN @485
EXIT
...
== 7XQUAYJ IF ~InParty("QUAYLE") InMyArea("QUAYLE") !StateCheck("QUAYLE",CD_STATE_NOTVALID)~ THEN @514
== 7XkagaJ IF ~InParty("KAGAIN") InMyArea("KAGAIN") !StateCheck("KAGAIN",CD_STATE_NOTVALID)~ THEN @515
== KORGANJ IF ~InParty("Korgan") !StateCheck("Korgan",CD_STATE_NOTVALID) OR(3) !InParty("KAGAIN") !InMyArea("KAGAIN") StateCheck("KAGAIN",CD_STATE_NOTVALID)~ THEN @515
...
== 7XMONTJ IF ~InParty("MONTARON") InMyArea("MONTARON") !StateCheck("MONTARON",CD_STATE_NOTVALID)~ THEN @518
=@519
== VICONIJ IF ~InParty("Viconia") InMyArea("Viconia") !StateCheck("Viconia",CD_STATE_NOTVALID)~ THEN @520
== 7XsharJ IF ~InParty("SHARTEEL") InMyArea("SHARTEEL") !StateCheck("SHARTEEL",CD_STATE_NOTVALID)~ THEN @521
...
== 7XTIAXJ IF ~InParty("TIAX") InMyArea("TIAX") !StateCheck("TIAX",CD_STATE_NOTVALID)~ THEN @523
END
