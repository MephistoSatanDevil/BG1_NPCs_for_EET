...
== 7XCoranJ IF ~InParty("CORAN")!StateCheck("CORAN",CD_STATE_NOTVALID)~ THEN
@87 
END
...
== 7XCoranJ IF ~InParty("CORAN")!StateCheck("CORAN",CD_STATE_NOTVALID)~ THEN @92
END
...
CHAIN IF WEIGHT #-1 ~InParty("CORAN")!StateCheck("CORAN",CD_STATE_NOTVALID)Global("coran_belmin","GLOBAL",0)~ THEN BELMIN CoranBelmin
...
== 7XCoranJ IF ~InParty("CORAN")!StateCheck("CORAN",CD_STATE_NOTVALID)~ THEN @102
== UDSILVER @23
END
...
== PLAYER1 IF ~InParty("CORAN")!StateCheck("CORAN",CD_STATE_NOTVALID)~ THEN
@103
END
