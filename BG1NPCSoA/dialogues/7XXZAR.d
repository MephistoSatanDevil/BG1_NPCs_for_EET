...
!InParty("XZAR")~ THEN BEGIN XZAR00x08
SAY @29
IF ~~ THEN REPLY @24 GOTO JOIN1
IF ~~ THEN REPLY @25 GOTO JOIN1
IF ~~ THEN REPLY @26 GOTO JOIN1
...
!InParty("XZAR")~ THEN BEGIN RejoinXZAR
SAY @41
...
@43
== 7XXZAR @44
== 7XMONT IF ~InMyArea("MONTARON")~ THEN @45
== JAHEIRAJ IF ~InMyArea("MONTARON")~ THEN @46
== 7XMONT IF ~InMyArea("MONTARON")~ THEN @47
== JAHEIRAJ IF ~InMyArea("MONTARON")~ THEN @48
== 7XMONT IF ~InMyArea("MONTARON")~ THEN @49
== 7XXZAR @50
END
