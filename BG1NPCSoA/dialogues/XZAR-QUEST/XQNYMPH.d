...
IF~Global("XZARQUESTSTART","GLOBAL",0)!InParty("XZAR")~ THEN BEGIN NEWINTRO
SAY @0
IF ~~ THEN EXIT
END

IF ~Global("XZARQUESTSTART","GLOBAL",0)IsValidForPartyDialog("XZAR")!Dead("XZAR")InParty("XZAR")~ THEN BEGIN QUESTNYMPH1-2
SAY @1
...
IF ~Global("XZARQUESTSTART","GLOBAL",1) IsValidForPartyDialog("XZAR")!Dead("XZAR")InParty("XZAR")~ THEN BEGIN NEWGAMESTART
SAY @18
