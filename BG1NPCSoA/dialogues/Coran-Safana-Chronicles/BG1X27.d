...
InParty("CORAN")InParty("SAFANA")
!StateCheck("SAFANA",CD_STATE_NOTVALID)
!StateCheck("CORAN",CD_STATE_NOTVALID)~ THEN BEGIN YAGO-REVENGE
SAY @0
IF ~!StateCheck("CORAN",CD_STATE_NOTVALID)InParty("CORAN")~ THEN REPLY @1 EXTERN ~7XCoranJ~ YAGOTalk
IF ~!StateCheck("CORAN",CD_STATE_NOTVALID)InParty("CORAN")~ THEN REPLY @2 EXTERN ~7XCoranJ~ YAGOTalk
IF ~!StateCheck("CORAN",CD_STATE_NOTVALID)InParty("CORAN")~ THEN REPLY @3 EXTERN ~7XCoranJ~ YAGOTalk
END
...
=
@7 
IF ~InParty("SAFANA")!StateCheck("SAFANA",CD_STATE_NOTVALID)~ THEN EXTERN ~7XSafaJ~ YAGOTalk2
END

IF ~~ THEN BEGIN REVENGE3
SAY @8
IF ~InParty("SAFANA")!StateCheck("SAFANA",CD_STATE_NOTVALID)~ THEN EXTERN ~7XSafaJ~ YAGOTalk3
END

IF ~~ THEN BEGIN REVENGE4
SAY @9
IF ~!StateCheck("CORAN",CD_STATE_NOTVALID)InParty("CORAN")~ THEN EXTERN ~7XCoranJ~ YAGOTalk4
END
...
=
@12
IF ~!StateCheck("CORAN",CD_STATE_NOTVALID)InParty("CORAN")~ THEN EXTERN ~7XCoranJ~ YAGOTalk5
END

IF ~~ THEN BEGIN REVENGE6
SAY @13
IF ~InParty("SAFANA")!StateCheck("SAFANA",CD_STATE_NOTVALID)~ THEN EXTERN ~7XSafaJ~ YAGOTalk6
END
