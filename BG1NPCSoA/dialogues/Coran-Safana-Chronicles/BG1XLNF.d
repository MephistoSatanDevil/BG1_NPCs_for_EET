...
IF ~Global("BG1XLNF","GLOBAL",0)InParty("CORAN")
!StateCheck("CORAN",CD_STATE_NOTVALID)~ THEN BEGIN INTRO
SAY @0
=
@1
...
=
@6
IF ~!StateCheck("CORAN",CD_STATE_NOTVALID)InParty("CORAN")~ THEN EXTERN ~7XCoranJ~ LanfearTalk2
END
...
=
@36
IF ~InParty("SAFANA")!StateCheck("SAFANA",CD_STATE_NOTVALID)~ THEN EXTERN ~7XSafaJ~ LanfearComment2
IF ~!InParty("SAFANA")~ THEN EXTERN ~BG1XLNF~ INTRO3
END
END
...
SAY @40
IF ~InParty("SAFANA")!StateCheck("SAFANA",CD_STATE_NOTVALID)~ THEN EXTERN ~7XSafaJ~ LanfearComment
IF ~~ THEN EXIT
END
END
...
SAY @41
IF ~InParty("SAFANA")!StateCheck("SAFANA",CD_STATE_NOTVALID)~ THEN EXIT
END
END
